...
$scope.applyBancoDoBrasilStyle = () => {
  ...
  $scope.obj.card_score_color = "#ffcd00"; // Yellow for score cards
  $scope.obj.card_level_color = "#ffcd00"; // Yellow for level card
  $scope.obj.card_achievements_color = "#ffcd00"; // Yellow for achievements cards
  $scope.obj.progress_bar_color = "#0066b3"; // Blue progress bar
  $scope.obj.progress_background_color = "#ffffff"; // White progress background
