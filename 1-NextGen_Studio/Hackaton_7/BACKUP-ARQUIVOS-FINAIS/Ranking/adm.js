$scope.obj = {
  ...
  other_players_color: "#ffffff", // Default white for other players
};
...
$scope.applyBancoDoBrasilStyle = () => {
  ...
  $scope.obj.current_player_color = "#ffcd00"; // Yellow for current player
  $scope.obj.first_place_color = "#ffcd00"; // Yellow for first place
  $scope.obj.second_place_color = "#ffcd00"; // Yellow for second place
  $scope.obj.third_place_color = "#ffcd00"; // Yellow for third place
  $scope.obj.avatar_border_color = "#ffcd00"; // Yellow avatar border
  $scope.obj.other_players_color = "#004a8f"; // Darker blue for other players
  $scope.obj.visible_leaderboards = $scope.obj.visible_leaderboards; // Maintain current leaderboards
