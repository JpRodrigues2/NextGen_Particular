$scope.obj = {
  ...
  disabled_items: [],
  background_color: "#7fbfb3", // Default background
  header_color: "#f9b87f", // Default header
  text_color: "#2d5d56", // Default text
};
...
$scope.applyBancoDoBrasilStyle = () => {
  ...
  $scope.obj.text_color = "#ffffff"; // White text for contrast
  $scope.obj.buy_button_color = "#ffcd00"; // Yellow buy button
  $scope.obj.buy_button_hover_color = "#e6b800"; // Darker yellow hover
  $scope.obj.insufficient_balance_color = "#d32f2f"; // Red for errors
  $scope.obj.disabled_items = $scope.obj.disabled_items; // Maintain current disabled items
