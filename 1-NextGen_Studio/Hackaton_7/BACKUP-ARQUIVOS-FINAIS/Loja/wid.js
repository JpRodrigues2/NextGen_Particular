  ...
  ($scope, $http, $timeout) => {
    ...
    function applyWhitelabelStyles() {
      ...
      if (cfg.background_color) {
        document.getElementById("loja").style.backgroundColor = cfg.background_color;
        document.getElementById("funifier-store-widget").style.backgroundColor = cfg.background_color;
      } else {
      ...
      // Header color
      if (cfg.header_color) {
        document.querySelector(".store-header").style.backgroundColor = cfg.header_color;
      } else {
      ...
      if (cfg.buy_button_hover_color) {
        const style = document.createElement("style");
        style.innerHTML = `
          #loja .buy-button:hover:not(:disabled) {
      ...
      if (cfg.insufficient_balance_color) {
        ...
        style.innerHTML = `
          #loja .error-message {
            ...
            border-color: ${cfg.insufficient_balance_color} !important;
          }
        `;
        document.head.appendChild(style);
      } else {
